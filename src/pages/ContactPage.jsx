    ...
    return (
        <main className={cl.container}>
            <iframe
                ...
                onLoad={handleLoad} // Track the load event and update loading state
            />
            {isLoading && <Preloader />}
            {!isLoading && (
                <p className={cl.contact__text}>
                Заказы можно забрать как по адресу: <br /> г.Харьков, ул.Клочковская, 178 <br /> Так и почтой на отделения Новой Почты
                </p>
            )}
        </main>
    );
